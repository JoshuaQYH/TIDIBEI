...
if __name__ == '__main__':
    #回测函数：
    run_backtest(strategy_name='ThreeLines', file_path='.', target_list=get_code_list('sz50')['code'],
                 frequency='day', fre_num=1, begin_date='2015-09-01', end_date='2018-03-01', fq=1)
