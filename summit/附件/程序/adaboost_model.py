...
def on_data(context):
    ...
    adaboost = AdaBoostRegressor(DecisionTreeRegressor(max_depth=9),
...
if __name__ == '__main__':
    ...
    file_path = 'adaboost_model.py'
    block = 'hs300'

    begin_date = '2016-01-01'
    end_date = '2018-09-30'

    strategy_name = 'adaboost'
